...
router.get("/requests/update_selection_status", async (req, res) => {
    try {
...
router.get("/requests/update_selection_status/:id", async (req, res) => {
    const { id } = req.params;
    try {
...
router.patch('/requests/update_selection_status/accept/:id', async (req, res) => {
...
router.patch('/requests/update_selection_status/reject/:id', async (req, res) => {
