...
class ApplicationsAdapter(private val applicationsClickListener: ApplicationsClickListener) :
    ListAdapter<TripApplication, ApplicationsAdapter.TripApplicationViewHolder>(
    ...
    class TripApplicationViewHolder(private val binding: ApplicationsListItemBinding) :
        ...
        fun bind(application: TripApplication, applicationsClickListener: ApplicationsClickListener) {
...
class ApplicationsComparator : DiffUtil.ItemCallback<TripApplication>() {
    override fun areItemsTheSame(
        oldItem: TripApplication,
        newItem: TripApplication
    ): Boolean {
